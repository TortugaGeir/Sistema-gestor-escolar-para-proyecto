...
(personas_id,especialidad,antiguedad,fyh_create,estado)
VALUES (:id_personas,:especialidad,:antiguedad,:fyh_create,:estado)");
...
try{
    if($sentencia->execute()){
      ...
      session_start();
        ...
        $_SESSION['mensaje'] = "Se ha registrado correctamente el docente";
