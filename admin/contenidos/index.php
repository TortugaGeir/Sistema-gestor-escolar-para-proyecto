          ...
          <tbody>
            ...
            foreach($asignaciones_docente as $asignacion){
              if($email_session == $asignacion['email']){ 
                ...
                $id_asignatura = $asignacion['id_asignaturas'];
                $contador_asignacion = $contador_asignacion + 1;?>
                  <tr>
                    ...
                    <td>
                      <a href="create.php?id_asignacion=<?=$id_asignacion;?>&id_docente=<?=$id_docente;?>&id_asignatura=<?=$id_asignatura;?>" class="btn btn-success btn-sm"><i class="bi bi-journal-bookmark-fill"></i>Contenido</a></td>
                  </tr>
