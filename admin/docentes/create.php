                  ...
                  <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <label for=""><b>Antiguedad en la Institución</b></label>
                        <input type="date" name="antiguedad" class="form-control" required>
                    </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                          ...
                          <textarea class="form-control" name="direccion_docente" rows="3" placeholder="Escriba la Dirección" style="margin-bottom: 12px;" required></textarea>
                        </div>
                      </div>
